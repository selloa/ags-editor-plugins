...
{
    partial class StateCatalogPane
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblFooter.Text = "Scans root *.asc/*.ash for GlobalInt defines and Get/SetGlobalInt usage. Filter uses AND-token matching; tree labels show matches/total.";
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.Controls.Add(this.lblFooter);
            this.Controls.Add(this.splitContainer);
            this.Controls.Add(this.toolStrip);
            this.Name = "StateCatalogPane";
